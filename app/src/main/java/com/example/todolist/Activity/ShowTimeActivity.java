...
import static com.example.todolist.Activity.WeekStats.weekUsage;
...
//        });
    ...
    {
        layoutInflater = (LayoutInflater) ShowTimeActivity.this.getSystemService((Context.LAYOUT_INFLATER_SERVICE));
    ...
    public void showPopUpView()
    {
        ...
        appsinfo_tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ShowTimeActivity.this,AppsActivity.class));
            }
        });
        ...
        weekstats_tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ShowTimeActivity.this,WeekStats.class));
            }
        });
